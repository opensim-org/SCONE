...
namespace scone
{
	MuscleSensor::MuscleSensor( const PropNode& pn, ParamSet& par, Model& model, const Area& target_area ) :
	...
	DofSensor::DofSensor( const PropNode& pn, ParamSet& par, Model& model, const Area& target_area ) :
		Sensor( pn, par, model, target_area ),
	...
	LegLoadSensor::LegLoadSensor( const PropNode& pn, ParamSet& par, Model& model, const Area& target_area ) :
		Sensor( pn, par, model, target_area ),
	...
	OrientationSensor::OrientationSensor( const PropNode& pn, ParamSet& par, Model& model, const Area& target_area ) :
		Sensor( pn, par, model, target_area ),
		m_Plane( Invalid ),
		m_Pelvis( nullptr ),
		m_Lumbar( nullptr )
	...
	BodySensor::BodySensor( const PropNode& pn, ParamSet& par, Model& model, const Area& target_area ) :
		Sensor( pn, par, model, target_area ),
	...
	{
		return flut::math::rotation_vector_from_quat( m_Body.GetOrientation() )[ idx ];
	}
